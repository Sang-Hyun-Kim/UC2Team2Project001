...
{
	for (const string s : orcArt)
	{
		ConsoleLayout::GetInstance().AppendLine(ConsoleRegionType::LeftBottom, s);
	}

	for (const string s : slimeArt)
	{
		ConsoleLayout::GetInstance().AppendLine(ConsoleRegionType::LeftTop, s);
	}
	for (const string s : dragonArt)
	{
		ConsoleLayout::GetInstance().AppendLine(ConsoleRegionType::RightTop, s);
	}
