...
- 이를 통해 상태 시스템을 손쉽게 생성하고 구현해서 원하는 스킬 효과에 넣어서 사용 가능하게 됩니다.
...
### 개요
- Item 시스템은 플레이어가 게임 플레이간 아이템을 사용, 획득, 구입, 판매하기 위해 사용되는 시스템입니다. 플레이어가 특정 효과를 위해 사용하는 Item과 플레이어나 상점이 Item을 보관하기 위한 클래스인 Inventory, GameSystem에서 Item을 생성, 획득, 구매, 판매 하기 위한 ItemManager로 구성되어 있습니다.
- 각 클래스는 목표하는 기능의 함수들을 제공하고 있습니다.
